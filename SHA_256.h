...
#ifndef SHA_256_BUFFER_SIZE_FOR_INPUT_ITERATOR
#define SHA_256_BUFFER_SIZE_FOR_INPUT_ITERATOR \
...
namespace SHA_256
{
    ...
    void hash256(InIter first, InIter last, OutIter first2, OutIter last2,
        int buffer_size = SHA_256_BUFFER_SIZE_FOR_INPUT_ITERATOR) {
        SHA_256::impl::hash256_impl(
